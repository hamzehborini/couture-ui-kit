...
export function SuitCard({ product, index, onSelect }: Props) {
  return (
    ...
    >
      <div className="relative aspect-[3/4] w-full overflow-hidden rounded-xl border border-white/5 transition-colors duration-500 group-hover:border-[var(--gold-soft)]">
        <img
